...
description: Use when working on theory and model craft for a The Journal of Law and Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory and Model Craft (jle-theory-model)

## When to trigger
- The manuscript is aimed at **The Journal of Law and Economics (JLE)** and theory and model craft is the active bottleneck.
...
5. End with a handoff to `jle-robustness` if the stage passes, or back to `jle-workflow` if it does not.
