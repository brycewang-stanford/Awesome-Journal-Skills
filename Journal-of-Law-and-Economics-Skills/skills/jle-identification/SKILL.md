...
description: Use when working on identification strategy for a The Journal of Law and Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Identification Strategy (jle-identification)

## When to trigger
- The manuscript is aimed at **The Journal of Law and Economics (JLE)** and identification strategy is the active bottleneck.
...
5. End with a handoff to `jle-theory-model` if the stage passes, or back to `jle-workflow` if it does not.
