---
name: jle-rebuttal
description: Use when working on rebuttal strategy for a The Journal of Law and Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jle-rebuttal)

## When to trigger
- The manuscript is aimed at **The Journal of Law and Economics (JLE)** and rebuttal strategy is the active bottleneck.
