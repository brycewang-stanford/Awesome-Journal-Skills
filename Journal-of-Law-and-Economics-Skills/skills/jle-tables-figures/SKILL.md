...
description: Use when working on tables and figures for a The Journal of Law and Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (jle-tables-figures)

## When to trigger
- The manuscript is aimed at **The Journal of Law and Economics (JLE)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `jle-writing-style` if the stage passes, or back to `jle-workflow` if it does not.
