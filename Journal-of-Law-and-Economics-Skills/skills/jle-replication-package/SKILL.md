...
description: Use when working on replication package for a The Journal of Law and Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Replication Package (jle-replication-package)

## When to trigger
- The manuscript is aimed at **The Journal of Law and Economics (JLE)** and replication package is the active bottleneck.
...
5. End with a handoff to `jle-referee-strategy` if the stage passes, or back to `jle-workflow` if it does not.
...
【Next skill】jle-referee-strategy
```
