<!-- Vendored from shared-resources/empirical-methods/code (Stata 18 MP verified, 2026-06) for JFE pack self-containment. Do not edit Stata/Python commands here; fix upstream and re-vendor. -->
