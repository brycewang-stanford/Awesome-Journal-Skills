...
| Item | Note |
|------|------|
| Submission portal | **Sage Track** (ScholarOne Manuscript Central), `mc.manuscriptcentral.com/nms` |
| Publisher | **SAGE** (since 1999; ISSN 1461-4448 / 1461-7315) |
| Review model | **Strictly anonymous (double-anonymized)** — masked manuscript + separate title page |
...
| Ethics | **SAGE/COPE** + **ICMJE**; online/platform-data ethics (consent, anonymization, ToS) |

## 6. Cautions
1. **Verify volatile specifics** (current editors and the 2026 transition, word/abstract caps, ORCID,
   APC, masking format) on the official SAGE/NM&S pages — they change; the SAGE author page may 403 to
   automated tools. Unverified items are 待核实.
