...
description: Use when working on internet appendix for a Financial Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Internet Appendix (finman-internet-appendix)

## When to trigger
- The manuscript is aimed at **Financial Management (FM)** and internet appendix is the active bottleneck.
...
5. End with a handoff to `finman-writing-style` if the stage passes, or back to `finman-workflow` if it does not.
...
【Skill】finman-internet-appendix
