...
description: Use when working on literature positioning for a Financial Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (finman-literature-positioning)

## When to trigger
- The manuscript is aimed at **Financial Management (FM)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `finman-identification` if the stage passes, or back to `finman-workflow` if it does not.
...
【Skill】finman-literature-positioning
