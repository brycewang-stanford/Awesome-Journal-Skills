...
description: Use when working on referee strategy for a Financial Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (finman-referee-strategy)

## When to trigger
- The manuscript is aimed at **Financial Management (FM)** and referee strategy is the active bottleneck.
