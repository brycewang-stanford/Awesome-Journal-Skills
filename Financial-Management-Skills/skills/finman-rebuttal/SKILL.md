...
description: Use when working on rebuttal strategy for a Financial Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (finman-rebuttal)

## When to trigger
- The manuscript is aimed at **Financial Management (FM)** and rebuttal strategy is the active bottleneck.
...
5. End with a handoff to `finman-rebuttal` if the stage passes, or back to `finman-workflow` if it does not.
