...
description: Use when working on tables and figures for a Financial Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (finman-tables-figures)

## When to trigger
- The manuscript is aimed at **Financial Management (FM)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `finman-internet-appendix` if the stage passes, or back to `finman-workflow` if it does not.
