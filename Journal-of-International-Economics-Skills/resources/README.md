# Journal of International Economics — Resources

Capability layer for the **Journal of International Economics** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a *Journal of International Economics* introduction in international-question → estimate-first → defended-identification style, written for both halves of the field. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of International Economics* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
