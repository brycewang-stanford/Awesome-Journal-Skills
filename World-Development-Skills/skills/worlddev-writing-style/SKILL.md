...
description: Use when working on writing style for a World Development manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (worlddev-writing-style)

## When to trigger
- The manuscript is aimed at **World Development (World Development)** and writing style is the active bottleneck.
...
5. End with a handoff to `worlddev-replication-package` if the stage passes, or back to `worlddev-workflow` if it does not.
