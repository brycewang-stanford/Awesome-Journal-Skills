...
description: Use when working on topic selection for a Journal of Management Information Systems manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jmis-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of Management Information Systems (JMIS)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jmis-theory-development` if the stage passes, or back to `jmis-workflow` if it does not.
