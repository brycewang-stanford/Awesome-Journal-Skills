...
description: Use when working on literature positioning for a Journal of Management Information Systems manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jmis-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Management Information Systems (JMIS)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jmis-methods` if the stage passes, or back to `jmis-workflow` if it does not.
...
【Skill】jmis-literature-positioning
