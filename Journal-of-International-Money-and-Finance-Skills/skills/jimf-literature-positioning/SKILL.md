...
description: Use when working on literature positioning for a Journal of International Money and Finance manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jimf-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of International Money and Finance (JIMF)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jimf-identification` if the stage passes, or back to `jimf-workflow` if it does not.
