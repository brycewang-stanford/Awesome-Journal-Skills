---
name: jimf-rebuttal
description: Use when working on rebuttal strategy for a Journal of International Money and Finance manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jimf-rebuttal)

## When to trigger
- The manuscript is aimed at **Journal of International Money and Finance (JIMF)** and rebuttal strategy is the active bottleneck.
...
5. End with a handoff to `jimf-rebuttal` if the stage passes, or back to `jimf-workflow` if it does not.
