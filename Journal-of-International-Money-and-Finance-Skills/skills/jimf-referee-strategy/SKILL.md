...
description: Use when working on referee strategy for a Journal of International Money and Finance manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (jimf-referee-strategy)

## When to trigger
- The manuscript is aimed at **Journal of International Money and Finance (JIMF)** and referee strategy is the active bottleneck.
