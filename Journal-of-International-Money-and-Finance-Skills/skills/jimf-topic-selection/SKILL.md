...
description: Use when working on topic selection for a Journal of International Money and Finance manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jimf-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of International Money and Finance (JIMF)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jimf-literature-positioning` if the stage passes, or back to `jimf-workflow` if it does not.
