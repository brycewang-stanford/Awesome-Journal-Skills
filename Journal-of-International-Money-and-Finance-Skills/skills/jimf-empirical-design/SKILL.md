...
description: Use when working on empirical design for a Journal of International Money and Finance manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Empirical Design (jimf-empirical-design)

## When to trigger
- The manuscript is aimed at **Journal of International Money and Finance (JIMF)** and empirical design is the active bottleneck.
...
5. End with a handoff to `jimf-robustness` if the stage passes, or back to `jimf-workflow` if it does not.
