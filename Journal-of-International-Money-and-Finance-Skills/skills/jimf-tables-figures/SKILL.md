...
description: Use when working on tables and figures for a Journal of International Money and Finance manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (jimf-tables-figures)

## When to trigger
- The manuscript is aimed at **Journal of International Money and Finance (JIMF)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `jimf-internet-appendix` if the stage passes, or back to `jimf-workflow` if it does not.
