...
description: Use when working on internet appendix for a Journal of International Money and Finance manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Internet Appendix (jimf-internet-appendix)

## When to trigger
- The manuscript is aimed at **Journal of International Money and Finance (JIMF)** and internet appendix is the active bottleneck.
...
5. End with a handoff to `jimf-writing-style` if the stage passes, or back to `jimf-workflow` if it does not.
