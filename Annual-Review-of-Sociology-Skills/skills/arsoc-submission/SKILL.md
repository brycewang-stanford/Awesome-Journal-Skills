...
- **Publisher / venue.** ARSoc is published by **Annual Reviews** (nonprofit), founded **1975** (ISSN 0360-0572 print / 1545-2115 online), as an **annual volume**; it is a **review series**, distinct from ASR/AJS (sociology's primary-research flagships), *Sociological Theory* (theory development), and the sister Annual Reviews of Psychology/Economics. Articles are **commissioned by the Editorial Committee**; there is **no cold-submission portal for unsolicited manuscripts** — delivery happens within the invited-article workflow (检索于 2026-06；以官网为准).
- **Editors.** Co-editors Douglas Massey & Mary C. Waters (检索于 2026-06；以官网为准 — re-confirm, editors rotate).
...
- **Length / abstract limits.** Exact word/abstract limits are **待核实** — confirm on the author pages; typical published reviews run ~8,000–12,000 words / ~20 pages (检索于 2026-06；以官网为准).
