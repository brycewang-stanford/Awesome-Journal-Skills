...
description: Use when working on replication package for a Journal of Environmental Economics and Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Replication Package (jeem-replication-package)

## When to trigger
- The manuscript is aimed at **Journal of Environmental Economics and Management (JEEM)** and replication package is the active bottleneck.
...
5. End with a handoff to `jeem-referee-strategy` if the stage passes, or back to `jeem-workflow` if it does not.
