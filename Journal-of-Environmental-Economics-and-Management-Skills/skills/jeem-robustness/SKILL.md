...
description: Use when working on robustness strategy for a Journal of Environmental Economics and Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Robustness Strategy (jeem-robustness)

## When to trigger
- The manuscript is aimed at **Journal of Environmental Economics and Management (JEEM)** and robustness strategy is the active bottleneck.
...
5. End with a handoff to `jeem-tables-figures` if the stage passes, or back to `jeem-workflow` if it does not.
