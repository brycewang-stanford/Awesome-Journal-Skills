...
description: Use when working on theory and model craft for a Journal of Environmental Economics and Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory and Model Craft (jeem-theory-model)

## When to trigger
- The manuscript is aimed at **Journal of Environmental Economics and Management (JEEM)** and theory and model craft is the active bottleneck.
...
5. End with a handoff to `jeem-robustness` if the stage passes, or back to `jeem-workflow` if it does not.
