...
description: Use when working on referee strategy for a Journal of Environmental Economics and Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (jeem-referee-strategy)

## When to trigger
- The manuscript is aimed at **Journal of Environmental Economics and Management (JEEM)** and referee strategy is the active bottleneck.
...
5. End with a handoff to `jeem-submission` if the stage passes, or back to `jeem-workflow` if it does not.
