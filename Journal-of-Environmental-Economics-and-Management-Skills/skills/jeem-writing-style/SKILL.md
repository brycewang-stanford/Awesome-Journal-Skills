...
description: Use when working on writing style for a Journal of Environmental Economics and Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (jeem-writing-style)

## When to trigger
- The manuscript is aimed at **Journal of Environmental Economics and Management (JEEM)** and writing style is the active bottleneck.
...
5. End with a handoff to `jeem-replication-package` if the stage passes, or back to `jeem-workflow` if it does not.
