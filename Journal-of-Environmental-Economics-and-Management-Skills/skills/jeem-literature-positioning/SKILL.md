...
description: Use when working on literature positioning for a Journal of Environmental Economics and Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jeem-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Environmental Economics and Management (JEEM)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jeem-identification` if the stage passes, or back to `jeem-workflow` if it does not.
