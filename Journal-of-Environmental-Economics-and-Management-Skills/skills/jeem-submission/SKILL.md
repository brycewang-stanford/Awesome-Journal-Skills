...
description: Use when working on submission preflight for a Journal of Environmental Economics and Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Submission Preflight (jeem-submission)

## When to trigger
- The manuscript is aimed at **Journal of Environmental Economics and Management (JEEM)** and submission preflight is the active bottleneck.
