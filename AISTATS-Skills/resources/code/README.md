# AISTATS ML Reproducibility Code Adapter

This directory points AISTATS authors to the repo-level ML conference methods kit.
...
`../official-source-map.md`, the current official CFP, and the AISTATS skills for
