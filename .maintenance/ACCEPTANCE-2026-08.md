...
**增补（2026-07-08 同日）**：初版签署后 owner 指示继续执行全部后续工作，第二波
扩张与质量换挡已完成——终态为 **203 pack / 2998 skill / category-8 14/100 /
CI scorecard 下限 94**，详见 §3.3–§3.4 增补段与 ROADMAP「Week 2 增补」。
...
### 3.4 category-8 进度（增补后 14/100）
初版验收时为 10/100。owner 随后指示把「下一步工作全部做完」，第二波
The Web Conference / WSDM / SIGIR / CVPR 已于同日建成并对账
（199→203 pack / 2950→2998 skill），category-8 现为 **14/100**。
Wave 25-A 下一批（ASSET-INVENTORY 已更新）：ICCV / ACL / EMNLP / ICRA。
按「每波过全部硬门槛」的节奏滚动，不冲量。
