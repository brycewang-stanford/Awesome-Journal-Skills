# Journal of Business and Economic Statistics — Resources

Capability layer for the **Journal of Business and Economic Statistics** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a methods-with-empirics introduction in JBES house style: lead with the method advance paired with empirical relevance, the target and identification, labeled assumptions and asymptotics, and finite-sample size/power evidence. |
...
| [`official-source-map.md`](official-source-map.md) | Venue-specific facts with sourcing discipline: stable JBES identity, current Joint Editors, ASA data policy, and live-T&F preflight boundaries for submission-only rules. |
| [`external_tools.md`](external_tools.md) | External tools / packages relevant to this venue. |
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Business & Economic Statistics* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
