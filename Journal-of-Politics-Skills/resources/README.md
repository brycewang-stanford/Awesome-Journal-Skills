# Journal of Politics — Resources

Capability layer for the **Journal of Politics** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | See a before→after rewrite of a political-science paper introduction in JOP house style (substantive question + testable theory + identification that adjudicates the strongest rival, quantity-first, fit to the page budget and anonymized). Illustrative fictional paper. |
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified Journal of Politics papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
