...
description: Use when working on referee strategy for a Journal of Financial Markets manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (jfm-referee-strategy)

## When to trigger
- The manuscript is aimed at **Journal of Financial Markets (JFM)** and referee strategy is the active bottleneck.
