...
description: Use when working on topic selection for a Journal of Financial Markets manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jfm-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of Financial Markets (JFM)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jfm-literature-positioning` if the stage passes, or back to `jfm-workflow` if it does not.
