...
description: Use when working on literature positioning for a Journal of Financial Markets manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jfm-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Financial Markets (JFM)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jfm-identification` if the stage passes, or back to `jfm-workflow` if it does not.
