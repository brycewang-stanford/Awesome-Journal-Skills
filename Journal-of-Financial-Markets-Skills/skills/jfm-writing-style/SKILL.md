...
description: Use when working on writing style for a Journal of Financial Markets manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (jfm-writing-style)

## When to trigger
- The manuscript is aimed at **Journal of Financial Markets (JFM)** and writing style is the active bottleneck.
...
5. End with a handoff to `jfm-submission` if the stage passes, or back to `jfm-workflow` if it does not.
