---
name: jfm-rebuttal
description: Use when working on rebuttal strategy for a Journal of Financial Markets manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jfm-rebuttal)

## When to trigger
- The manuscript is aimed at **Journal of Financial Markets (JFM)** and rebuttal strategy is the active bottleneck.
...
5. End with a handoff to `jfm-rebuttal` if the stage passes, or back to `jfm-workflow` if it does not.
