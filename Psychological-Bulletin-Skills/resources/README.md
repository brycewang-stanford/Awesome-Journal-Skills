...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a Psychological Bulletin introduction in open question → meta-analytic synthesis → pooled effect + moderator + bias-check contribution style. Fictional teaching paper. |
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Psychological Bulletin* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
