...
description: Use when working on review process for a Journal of Consumer Psychology manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Review Process (jcp-review-process)

## When to trigger
- The manuscript is aimed at **Journal of Consumer Psychology (JCP)** and review process is the active bottleneck.
...
5. End with a handoff to `jcp-rebuttal` if the stage passes, or back to `jcp-workflow` if it does not.
