---
name: jcp-rebuttal
description: Use when working on rebuttal strategy for a Journal of Consumer Psychology manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jcp-rebuttal)

## When to trigger
- The manuscript is aimed at **Journal of Consumer Psychology (JCP)** and rebuttal strategy is the active bottleneck.
