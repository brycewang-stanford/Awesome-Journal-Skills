...
description: Use when working on literature positioning for a Journal of Consumer Psychology manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jcp-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Consumer Psychology (JCP)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jcp-methods` if the stage passes, or back to `jcp-workflow` if it does not.
...
【Skill】jcp-literature-positioning
