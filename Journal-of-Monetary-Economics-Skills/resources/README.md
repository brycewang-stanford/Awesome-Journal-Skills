# Journal of Monetary Economics — Resources

Capability layer for the **Journal of Monetary Economics** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a *Journal of Monetary Economics* introduction in macro-question → estimate-first → defended-identification style with a policy payoff. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Monetary Economics* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
