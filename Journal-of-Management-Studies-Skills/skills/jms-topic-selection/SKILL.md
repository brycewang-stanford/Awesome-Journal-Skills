...
description: Use when working on topic selection for a Journal of Management Studies manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jms-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of Management Studies (JMS)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jms-theory-development` if the stage passes, or back to `jms-workflow` if it does not.
...
【Next skill】jms-theory-development
```
