...
| [`official-source-map.md`](official-source-map.md) | Venue-specific facts (fee/membership, article types, blinding, data policy, portal) with sourcing discipline and 待核实 markers. |
