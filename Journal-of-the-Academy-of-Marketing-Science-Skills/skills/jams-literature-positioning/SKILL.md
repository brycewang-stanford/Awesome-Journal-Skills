...
description: Use when working on literature positioning for a Journal of the Academy of Marketing Science manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jams-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of the Academy of Marketing Science (JAMS)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jams-methods` if the stage passes, or back to `jams-workflow` if it does not.
...
【Skill】jams-literature-positioning
