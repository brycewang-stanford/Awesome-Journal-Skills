...
description: Use when working on theory development for a Journal of the Academy of Marketing Science manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory Development (jams-theory-development)

## When to trigger
- The manuscript is aimed at **Journal of the Academy of Marketing Science (JAMS)** and theory development is the active bottleneck.
...
5. End with a handoff to `jams-literature-positioning` if the stage passes, or back to `jams-workflow` if it does not.
