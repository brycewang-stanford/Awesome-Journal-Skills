# Journal of Econometrics — Resources

Capability layer for the **Journal of Econometrics** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a methodological introduction in JoE house style: lead with the estimator's property, the estimand, identification and labeled assumptions, the asymptotics, and finite-sample (Monte Carlo) evidence. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Econometrics* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
