# NeurIPS ML Reproducibility Code Adapter

This directory points NeurIPS authors to the repo-level ML conference methods kit.
...
`../official-source-map.md`, the current official CFP, and the NeurIPS skills for
