...
- **No upfront submission fee** is identified (待核实 — inferred from standard Elsevier practice, not an official quote). Optional **gold open access** carries an **Article Publishing Charge of USD 2,860 excluding tax** (re-confirmed on the ScienceDirect GEB listing 2026-06-22), only for accepted papers whose authors choose OA — re-verify before submission, as APCs change.
