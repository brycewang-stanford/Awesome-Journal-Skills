...
description: Use when working on tables and figures for a Entrepreneurship Theory and Practice manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (etp-tables-figures)

## When to trigger
- The manuscript is aimed at **Entrepreneurship Theory and Practice (ETP)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `etp-writing-style` if the stage passes, or back to `etp-workflow` if it does not.
