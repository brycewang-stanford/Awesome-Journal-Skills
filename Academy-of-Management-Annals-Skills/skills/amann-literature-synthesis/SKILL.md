...
description: Use when working on literature synthesis for a Academy of Management Annals manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Synthesis (amann-literature-synthesis)

## When to trigger
- The manuscript is aimed at **Academy of Management Annals (Annals)** and literature synthesis is the active bottleneck.
...
1. State the exact literature synthesis question in one sentence.
...
5. End with a handoff to `amann-organizing-framework` if the stage passes, or back to `amann-workflow` if it does not.
...
- [ ] The role-specific deliverable for literature synthesis names the next decision, not just prose edits.
...
【Skill】amann-literature-synthesis
【Verdict】pass / revise / reroute
【Binding issue】one concrete issue blocking literature synthesis
【Evidence needed】data, model, literature, exhibit, or policy source
【Sibling boundary】why not Academy of Management Review, Journal of Management
【Source status】verified URL / 待核实 / not asserted
【Next skill】amann-organizing-framework
```
