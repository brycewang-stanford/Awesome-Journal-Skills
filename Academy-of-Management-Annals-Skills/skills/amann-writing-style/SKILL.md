...
description: Use when working on writing style for a Academy of Management Annals manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (amann-writing-style)

## When to trigger
- The manuscript is aimed at **Academy of Management Annals (Annals)** and writing style is the active bottleneck.
...
5. End with a handoff to `amann-editor-strategy` if the stage passes, or back to `amann-workflow` if it does not.
...
【Next skill】amann-editor-strategy
```
