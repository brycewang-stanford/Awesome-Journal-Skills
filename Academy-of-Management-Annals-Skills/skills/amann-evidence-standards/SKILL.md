...
description: Use when working on evidence standards for a Academy of Management Annals manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Evidence Standards (amann-evidence-standards)

## When to trigger
- The manuscript is aimed at **Academy of Management Annals (Annals)** and evidence standards is the active bottleneck.
...
5. End with a handoff to `amann-tables-figures` if the stage passes, or back to `amann-workflow` if it does not.
...
【Skill】amann-evidence-standards
...
【Next skill】amann-tables-figures
```
