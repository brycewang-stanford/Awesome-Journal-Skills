...
description: Use when working on editor strategy for a Academy of Management Annals manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Editor Strategy (amann-editor-strategy)

## When to trigger
- The manuscript is aimed at **Academy of Management Annals (Annals)** and editor strategy is the active bottleneck.
...
5. End with a handoff to `amann-submission` if the stage passes, or back to `amann-workflow` if it does not.
