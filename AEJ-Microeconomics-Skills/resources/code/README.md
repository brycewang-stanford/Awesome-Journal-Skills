<!-- Vendored 2026-06 for AEJ: Microeconomics from shared-resources/empirical-methods/code; relevant only to the journal's empirical/structural/experimental subset — pure-theory papers should instead see resources/README.md (theory-model + proof-appendix craft). -->
