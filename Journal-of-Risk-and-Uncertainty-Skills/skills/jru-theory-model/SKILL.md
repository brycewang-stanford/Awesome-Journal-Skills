...
description: Use when working on theory and model craft for a Journal of Risk and Uncertainty manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory and Model Craft (jru-theory-model)

## When to trigger
- The manuscript is aimed at **Journal of Risk and Uncertainty (JRU)** and theory and model craft is the active bottleneck.
...
5. End with a handoff to `jru-robustness` if the stage passes, or back to `jru-workflow` if it does not.
