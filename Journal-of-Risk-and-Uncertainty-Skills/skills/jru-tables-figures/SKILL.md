...
description: Use when working on tables and figures for a Journal of Risk and Uncertainty manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (jru-tables-figures)

## When to trigger
- The manuscript is aimed at **Journal of Risk and Uncertainty (JRU)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `jru-writing-style` if the stage passes, or back to `jru-workflow` if it does not.
