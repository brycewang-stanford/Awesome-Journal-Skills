---
name: jru-rebuttal
description: Use when working on rebuttal strategy for a Journal of Risk and Uncertainty manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jru-rebuttal)

## When to trigger
- The manuscript is aimed at **Journal of Risk and Uncertainty (JRU)** and rebuttal strategy is the active bottleneck.
