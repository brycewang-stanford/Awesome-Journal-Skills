# Manufacturing and Service Operations Management — Resources

Capability layer for the **Manufacturing and Service Operations Management** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | See a before→after rewrite of an operations-management paper introduction in M&SOM house style — operational decision first, policy structure and managerial lever before notation, plus the four-part structured abstract. Illustrative fictional paper. |
| [`exemplars/library.md`](exemplars/library.md) | Benchmark against **real, web-verified M&SOM papers** organized by method × topic (DOI stem `10.1287/msom`). Design positioning only — no fabricated results — with explicit sibling-confusion guardrails (not OPRE / MNSC / POM / JOM). |
