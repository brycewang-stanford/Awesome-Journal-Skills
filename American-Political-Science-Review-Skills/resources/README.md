# American Political Science Review — Resources

Capability layer for the **American Political Science Review** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | See a before→after rewrite of a political-science paper introduction in APSR house style (question → general significance → argument → finding, with the contribution stated early for the whole discipline). Illustrative fictional paper. |
| [`exemplars/library.md`](exemplars/library.md) | Benchmark against **real, web-verified APSR papers** organized by subfield × method (formal theory, survey experiment, natural experiment, observational, interpretive). Design positioning only — no fabricated findings; includes a sibling-journal do-not-misattribute list. |
