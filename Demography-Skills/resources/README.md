...
Capability layer for the **Demography** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a *Demography* introduction in population-question → quantity-first → decomposition-contribution style. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Demography* (PAA / Duke UP) papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
