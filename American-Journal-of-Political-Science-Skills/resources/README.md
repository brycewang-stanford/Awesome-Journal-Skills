# American Journal of Political Science — Resources

Capability layer for the **American Journal of Political Science** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | See a before→after rewrite of a political-science paper introduction in AJPS house style (front-loaded contribution, hypothesis before results, identification defended, magnitude + uncertainty). Illustrative fictional paper. |
| [`exemplars/library.md`](exemplars/library.md) | Benchmark against **real, web-verified AJPS papers** organized by subfield × method. Design positioning only — no fabricated numbers; includes a sibling-confusion guardrail (APSR / JOP / *World Politics* / IO / *Political Analysis* are not AJPS). |
...
1. **When framing the paper** — model the introduction on [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md), and benchmark your subfield × method against the verified papers in [`exemplars/library.md`](exemplars/library.md).
