...
Capability layer for the **Psychological Science** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a Psychological Science introduction in phenomenon → preregistered test → concise result-forward contribution style. Fictional teaching paper. |
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Psychological Science* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
