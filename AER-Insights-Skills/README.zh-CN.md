...
JEL 代码与 AEA 数据与代码可得性政策。

**官方依据核对于 2026-06**（检索于 2026-06；以官网为准）：AEA / AER: Insights 投稿与编辑政策页面、编辑名单页，
以及 AEA 数据与代码可得性政策。来源与诚实的"待核实"标记见
...
| AEA 排版规范 | **不用显著性星号**；报告标准误 / 置信区间；双盲匿名 |
...
| 11 | [`aeri-submission`](skills/aeri-submission/SKILL.md) | 投稿前最终核查：词数/图表门槛、摘要、匿名、JEL、费用、数据政策 |
