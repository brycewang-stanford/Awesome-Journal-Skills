# Journal of Personality and Social Psychology — Resources

Capability layer for the **Journal of Personality and Social Psychology** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a JPSP introduction in psychological question → theory + mechanism → converging multi-study package → effect-with-interval contribution style. Fictional teaching paper. |
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Personality and Social Psychology* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
