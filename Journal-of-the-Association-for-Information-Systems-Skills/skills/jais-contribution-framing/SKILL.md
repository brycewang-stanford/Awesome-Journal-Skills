...
description: Use when working on contribution framing for a Journal of the Association for Information Systems manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Contribution Framing (jais-contribution-framing)

## When to trigger
- The manuscript is aimed at **Journal of the Association for Information Systems (JAIS)** and contribution framing is the active bottleneck.
...
5. End with a handoff to `jais-tables-figures` if the stage passes, or back to `jais-workflow` if it does not.
...
【Skill】jais-contribution-framing
