---
name: jais-methods
description: Use when working on methods for a Journal of the Association for Information Systems manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Methods (jais-methods)

## When to trigger
- The manuscript is aimed at **Journal of the Association for Information Systems (JAIS)** and methods is the active bottleneck.
...
5. End with a handoff to `jais-data-analysis` if the stage passes, or back to `jais-workflow` if it does not.
