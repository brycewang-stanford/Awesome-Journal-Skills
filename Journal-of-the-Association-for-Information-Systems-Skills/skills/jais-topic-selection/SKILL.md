...
description: Use when working on topic selection for a Journal of the Association for Information Systems manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jais-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of the Association for Information Systems (JAIS)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jais-theory-development` if the stage passes, or back to `jais-workflow` if it does not.
