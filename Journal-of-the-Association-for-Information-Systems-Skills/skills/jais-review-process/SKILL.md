...
description: Use when working on review process for a Journal of the Association for Information Systems manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Review Process (jais-review-process)

## When to trigger
- The manuscript is aimed at **Journal of the Association for Information Systems (JAIS)** and review process is the active bottleneck.
