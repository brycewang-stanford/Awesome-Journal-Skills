...
description: Use when working on theory and model craft for a Journal of Economic Geography manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory and Model Craft (jegeo-theory-model)

## When to trigger
- The manuscript is aimed at **Journal of Economic Geography (JEG)** and theory and model craft is the active bottleneck.
...
5. End with a handoff to `jegeo-robustness` if the stage passes, or back to `jegeo-workflow` if it does not.
