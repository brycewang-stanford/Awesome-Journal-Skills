...
description: Use when working on referee strategy for a Journal of Economic Geography manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (jegeo-referee-strategy)

## When to trigger
- The manuscript is aimed at **Journal of Economic Geography (JEG)** and referee strategy is the active bottleneck.
...
5. End with a handoff to `jegeo-submission` if the stage passes, or back to `jegeo-workflow` if it does not.
