...
description: Use when working on writing style for a Journal of Economic Geography manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (jegeo-writing-style)

## When to trigger
- The manuscript is aimed at **Journal of Economic Geography (JEG)** and writing style is the active bottleneck.
...
5. End with a handoff to `jegeo-replication-package` if the stage passes, or back to `jegeo-workflow` if it does not.
