...
description: Use when working on tables and figures for a Annual Review of Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (arecon-tables-figures)

## When to trigger
- The manuscript is aimed at **Annual Review of Economics (AREcon)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `arecon-writing-style` if the stage passes, or back to `arecon-workflow` if it does not.
...
【Next skill】arecon-writing-style
```
