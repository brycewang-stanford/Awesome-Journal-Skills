...
description: Use when working on organizing framework for a Annual Review of Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Organizing Framework (arecon-organizing-framework)

## When to trigger
- The manuscript is aimed at **Annual Review of Economics (AREcon)** and organizing framework is the active bottleneck.
...
5. End with a handoff to `arecon-evidence-standards` if the stage passes, or back to `arecon-workflow` if it does not.
...
【Skill】arecon-organizing-framework
...
【Next skill】arecon-evidence-standards
```
