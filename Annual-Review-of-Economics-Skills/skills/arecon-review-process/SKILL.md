...
description: Use when working on review process for a Annual Review of Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Review Process (arecon-review-process)

## When to trigger
- The manuscript is aimed at **Annual Review of Economics (AREcon)** and review process is the active bottleneck.
