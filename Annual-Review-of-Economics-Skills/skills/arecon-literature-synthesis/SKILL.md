...
description: Use when working on literature synthesis for a Annual Review of Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Synthesis (arecon-literature-synthesis)

## When to trigger
- The manuscript is aimed at **Annual Review of Economics (AREcon)** and literature synthesis is the active bottleneck.
...
5. End with a handoff to `arecon-organizing-framework` if the stage passes, or back to `arecon-workflow` if it does not.
...
【Skill】arecon-literature-synthesis
...
【Next skill】arecon-organizing-framework
```
