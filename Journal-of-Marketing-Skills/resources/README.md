# Journal of Marketing — Resources

Capability layer for the **Journal of Marketing** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before->after rewrite of a Journal of Marketing introduction in JM house style (phenomenon -> why-it-matters -> question, with the substantive *and* managerial/policy contribution stated early), derived from this pack's writing-style / contribution-framing / topic-selection skills. Fictional illustrative paper; no invented journal policy. |
| [`exemplars/library.md`](exemplars/library.md) | Benchmark against **real, web-verified Journal of Marketing papers** by method x topic (sibling-confusion guarded vs. JMR / Marketing Science / JCR / JAMS / JCP). Design and framing positioning only -- no fabricated numbers. |
