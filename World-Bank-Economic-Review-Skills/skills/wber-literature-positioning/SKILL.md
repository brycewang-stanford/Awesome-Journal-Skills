...
description: Use when working on literature positioning for a The World Bank Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (wber-literature-positioning)

## When to trigger
- The manuscript is aimed at **The World Bank Economic Review (WBER)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `wber-identification` if the stage passes, or back to `wber-workflow` if it does not.
...
【Skill】wber-literature-positioning
...
【Next skill】wber-identification
```
