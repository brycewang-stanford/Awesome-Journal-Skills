...
description: Use when working on submission preflight for a The World Bank Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Submission Preflight (wber-submission)

## When to trigger
- The manuscript is aimed at **The World Bank Economic Review (WBER)** and submission preflight is the active bottleneck.
