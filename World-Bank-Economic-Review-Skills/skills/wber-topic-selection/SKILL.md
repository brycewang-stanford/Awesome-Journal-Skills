...
description: Use when working on topic selection for a The World Bank Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (wber-topic-selection)

## When to trigger
- The manuscript is aimed at **The World Bank Economic Review (WBER)** and topic selection is the active bottleneck.
...
5. End with a handoff to `wber-literature-positioning` if the stage passes, or back to `wber-workflow` if it does not.
