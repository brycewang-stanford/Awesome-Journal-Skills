# The World Bank Economic Review Resource Layer

This directory supports the `wber-*` skills with source-backed references and reproducibility scaffolding.

| Resource | Purpose |
|----------|---------|
| [`official-source-map.md`](official-source-map.md) | Official URLs and volatile facts for WBER |
