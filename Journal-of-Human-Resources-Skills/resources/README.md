# Journal of Human Resources — Resources

Capability layer for the **Journal of Human Resources** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a JHR introduction in policy-question → causal-estimate → reconciliation style. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Human Resources* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
