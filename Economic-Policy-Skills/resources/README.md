# Economic Policy Resource Layer

This directory supports the `ecopol-*` skills with source-backed references and reproducibility scaffolding.

| Resource | Purpose |
|----------|---------|
| [`official-source-map.md`](official-source-map.md) | Official URLs and volatile facts for Economic Policy |
