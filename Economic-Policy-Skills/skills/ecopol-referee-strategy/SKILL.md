...
description: Use when working on referee strategy for a Economic Policy manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (ecopol-referee-strategy)

## When to trigger
- The manuscript is aimed at **Economic Policy (Economic Policy)** and referee strategy is the active bottleneck.
...
5. End with a handoff to `ecopol-submission` if the stage passes, or back to `ecopol-workflow` if it does not.
