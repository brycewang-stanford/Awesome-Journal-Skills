# Journal of Financial and Quantitative Analysis — Resources

Capability layer for the **Journal of Financial and Quantitative Analysis** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | A fully fictional, labeled before→after JFQA introduction: financial-economics question → headline estimate with magnitude and interval → identification → economic mechanism → contribution, in JFQA house style. |
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Financial and Quantitative Analysis* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
