# Journal of Economic Growth — Resources

Capability layer for the **Journal of Economic Growth** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a *Journal of Economic Growth* introduction in growth-question → estimate-first → defended-identification style. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Economic Growth* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
