# American Journal of Sociology — Resources

Capability layer for the **American Journal of Sociology** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | See a before→after rewrite of a sociology paper introduction in AJS house style (theoretical puzzle + portable mechanism + design + finding + contribution to sociological theory). Illustrative fictional paper, derived from this pack's own skills. |
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified AJS papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
