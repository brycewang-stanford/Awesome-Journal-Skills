# Research Policy Resource Layer

This directory supports the `respol-*` skills with source-backed references and reproducibility scaffolding.

| Resource | Purpose |
|----------|---------|
| [`official-source-map.md`](official-source-map.md) | Official URLs and volatile facts for Research Policy |
