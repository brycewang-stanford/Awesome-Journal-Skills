...
description: Use when working on writing style for a International Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (ier-writing-style)

## When to trigger
- The manuscript is aimed at **International Economic Review (IER)** and writing style is the active bottleneck.
...
5. End with a handoff to `ier-replication-package` if the stage passes, or back to `ier-workflow` if it does not.
