...
description: Use when working on tables and figures for a International Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (ier-tables-figures)

## When to trigger
- The manuscript is aimed at **International Economic Review (IER)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `ier-writing-style` if the stage passes, or back to `ier-workflow` if it does not.
