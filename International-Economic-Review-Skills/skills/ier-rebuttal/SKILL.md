---
name: ier-rebuttal
description: Use when working on rebuttal strategy for a International Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (ier-rebuttal)

## When to trigger
- The manuscript is aimed at **International Economic Review (IER)** and rebuttal strategy is the active bottleneck.
