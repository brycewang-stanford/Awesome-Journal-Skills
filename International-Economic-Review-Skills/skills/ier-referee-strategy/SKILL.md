...
description: Use when working on referee strategy for a International Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (ier-referee-strategy)

## When to trigger
- The manuscript is aimed at **International Economic Review (IER)** and referee strategy is the active bottleneck.
...
5. End with a handoff to `ier-submission` if the stage passes, or back to `ier-workflow` if it does not.
