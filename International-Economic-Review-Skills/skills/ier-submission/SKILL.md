---
name: ier-submission
description: Use when working on submission preflight for a International Economic Review manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Submission Preflight (ier-submission)

## When to trigger
- The manuscript is aimed at **International Economic Review (IER)** and submission preflight is the active bottleneck.
...
5. End with a handoff to `ier-rebuttal` if the stage passes, or back to `ier-workflow` if it does not.
