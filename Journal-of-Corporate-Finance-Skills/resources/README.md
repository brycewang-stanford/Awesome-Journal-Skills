# Journal of Corporate Finance — Resources

Capability layer for the **Journal of Corporate Finance** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a JCF introduction in corporate-finance-question → headline-estimate → identification → mechanism style. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Corporate Finance* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
