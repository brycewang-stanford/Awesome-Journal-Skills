<!-- 自 Economic-Research-Journal-Skills/resources/code 引入（Stata 18 MP 已实跑验证，2026-06），用于 Journal-of-Quantitative-and-Technological-Economics-Skills 自包含。命令以规范源为准，勿在此处擅改。 -->
# 代码模板库（Stata + Python）
