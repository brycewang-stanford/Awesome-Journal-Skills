...
> Editor titles vary across sources (Subodha Kumar is listed as Co-/Deputy Editor-in-Chief); the department roster and Department Editors rotate. Verify the live masthead and departments at poms.org/journal. Submission fee and any data-deposit mandate are **待核实** — see `resources/official-source-map.md`.
