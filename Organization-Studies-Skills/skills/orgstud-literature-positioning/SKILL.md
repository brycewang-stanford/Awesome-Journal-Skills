...
description: Use when working on literature positioning for a Organization Studies manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (orgstud-literature-positioning)

## When to trigger
- The manuscript is aimed at **Organization Studies (OS)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `orgstud-methods` if the stage passes, or back to `orgstud-workflow` if it does not.
...
【Skill】orgstud-literature-positioning
