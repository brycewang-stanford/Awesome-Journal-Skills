...
description: Use when working on topic selection for a Organization Studies manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (orgstud-topic-selection)

## When to trigger
- The manuscript is aimed at **Organization Studies (OS)** and topic selection is the active bottleneck.
...
5. End with a handoff to `orgstud-theory-development` if the stage passes, or back to `orgstud-workflow` if it does not.
