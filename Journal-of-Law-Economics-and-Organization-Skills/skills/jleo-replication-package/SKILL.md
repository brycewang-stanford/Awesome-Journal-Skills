...
description: Use when working on replication package for a Journal of Law, Economics, and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Replication Package (jleo-replication-package)

## When to trigger
- The manuscript is aimed at **Journal of Law, Economics, and Organization (JLEO)** and replication package is the active bottleneck.
...
5. End with a handoff to `jleo-referee-strategy` if the stage passes, or back to `jleo-workflow` if it does not.
...
【Skill】jleo-replication-package
