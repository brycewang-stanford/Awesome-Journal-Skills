...
description: Use when working on writing style for a Journal of Law, Economics, and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (jleo-writing-style)

## When to trigger
- The manuscript is aimed at **Journal of Law, Economics, and Organization (JLEO)** and writing style is the active bottleneck.
...
5. End with a handoff to `jleo-replication-package` if the stage passes, or back to `jleo-workflow` if it does not.
