...
description: Use when working on robustness strategy for a Journal of Law, Economics, and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Robustness Strategy (jleo-robustness)

## When to trigger
- The manuscript is aimed at **Journal of Law, Economics, and Organization (JLEO)** and robustness strategy is the active bottleneck.
...
5. End with a handoff to `jleo-tables-figures` if the stage passes, or back to `jleo-workflow` if it does not.
