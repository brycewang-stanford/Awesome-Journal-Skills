...
description: Use when working on topic selection for a Journal of Law, Economics, and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jleo-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of Law, Economics, and Organization (JLEO)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jleo-literature-positioning` if the stage passes, or back to `jleo-workflow` if it does not.
