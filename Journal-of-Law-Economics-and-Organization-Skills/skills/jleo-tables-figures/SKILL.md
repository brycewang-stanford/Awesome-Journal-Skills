...
description: Use when working on tables and figures for a Journal of Law, Economics, and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (jleo-tables-figures)

## When to trigger
- The manuscript is aimed at **Journal of Law, Economics, and Organization (JLEO)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `jleo-writing-style` if the stage passes, or back to `jleo-workflow` if it does not.
