...
description: Use when working on theory and model craft for a Journal of Law, Economics, and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory and Model Craft (jleo-theory-model)

## When to trigger
- The manuscript is aimed at **Journal of Law, Economics, and Organization (JLEO)** and theory and model craft is the active bottleneck.
...
5. End with a handoff to `jleo-robustness` if the stage passes, or back to `jleo-workflow` if it does not.
