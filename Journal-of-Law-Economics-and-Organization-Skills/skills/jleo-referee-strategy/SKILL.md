...
description: Use when working on referee strategy for a Journal of Law, Economics, and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (jleo-referee-strategy)

## When to trigger
- The manuscript is aimed at **Journal of Law, Economics, and Organization (JLEO)** and referee strategy is the active bottleneck.
...
5. End with a handoff to `jleo-submission` if the stage passes, or back to `jleo-workflow` if it does not.
