...
description: Use when working on identification strategy for a Journal of Money, Credit and Banking manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Identification Strategy (jmcb-identification)

## When to trigger
- The manuscript is aimed at **Journal of Money, Credit and Banking (JMCB)** and identification strategy is the active bottleneck.
...
5. End with a handoff to `jmcb-empirical-design` if the stage passes, or back to `jmcb-workflow` if it does not.
