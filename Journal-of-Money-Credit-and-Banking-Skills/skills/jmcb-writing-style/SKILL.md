...
description: Use when working on writing style for a Journal of Money, Credit and Banking manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (jmcb-writing-style)

## When to trigger
- The manuscript is aimed at **Journal of Money, Credit and Banking (JMCB)** and writing style is the active bottleneck.
...
5. End with a handoff to `jmcb-submission` if the stage passes, or back to `jmcb-workflow` if it does not.
