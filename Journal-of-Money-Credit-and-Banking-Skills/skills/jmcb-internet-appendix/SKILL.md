...
description: Use when working on internet appendix for a Journal of Money, Credit and Banking manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Internet Appendix (jmcb-internet-appendix)

## When to trigger
- The manuscript is aimed at **Journal of Money, Credit and Banking (JMCB)** and internet appendix is the active bottleneck.
...
5. End with a handoff to `jmcb-writing-style` if the stage passes, or back to `jmcb-workflow` if it does not.
