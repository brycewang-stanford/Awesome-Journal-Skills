---
name: jmcb-rebuttal
description: Use when working on rebuttal strategy for a Journal of Money, Credit and Banking manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jmcb-rebuttal)

## When to trigger
- The manuscript is aimed at **Journal of Money, Credit and Banking (JMCB)** and rebuttal strategy is the active bottleneck.
...
5. End with a handoff to `jmcb-rebuttal` if the stage passes, or back to `jmcb-workflow` if it does not.
