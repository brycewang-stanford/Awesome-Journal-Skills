...
description: Use when working on literature positioning for a Journal of Money, Credit and Banking manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jmcb-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Money, Credit and Banking (JMCB)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jmcb-identification` if the stage passes, or back to `jmcb-workflow` if it does not.
