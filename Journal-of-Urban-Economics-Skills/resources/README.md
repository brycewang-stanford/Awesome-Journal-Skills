# Journal of Urban Economics Resource Layer

This directory supports the `jue-*` skills with source-backed references and reproducibility scaffolding.

| Resource | Purpose |
|----------|---------|
| [`official-source-map.md`](official-source-map.md) | Official URLs and volatile facts for JUE |
