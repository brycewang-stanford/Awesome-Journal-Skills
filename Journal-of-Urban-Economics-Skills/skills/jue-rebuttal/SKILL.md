---
name: jue-rebuttal
description: Use when working on rebuttal strategy for a Journal of Urban Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jue-rebuttal)

## When to trigger
- The manuscript is aimed at **Journal of Urban Economics (JUE)** and rebuttal strategy is the active bottleneck.
