---
name: jue-submission
description: Use when working on submission preflight for a Journal of Urban Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Submission Preflight (jue-submission)

## When to trigger
- The manuscript is aimed at **Journal of Urban Economics (JUE)** and submission preflight is the active bottleneck.
...
5. End with a handoff to `jue-rebuttal` if the stage passes, or back to `jue-workflow` if it does not.
