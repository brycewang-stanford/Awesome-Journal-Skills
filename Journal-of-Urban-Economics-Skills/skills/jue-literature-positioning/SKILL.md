...
description: Use when working on literature positioning for a Journal of Urban Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jue-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Urban Economics (JUE)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jue-identification` if the stage passes, or back to `jue-workflow` if it does not.
...
【Skill】jue-literature-positioning
