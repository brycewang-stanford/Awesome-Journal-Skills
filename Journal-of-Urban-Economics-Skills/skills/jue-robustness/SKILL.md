---
name: jue-robustness
description: Use when working on robustness strategy for a Journal of Urban Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Robustness Strategy (jue-robustness)

## When to trigger
- The manuscript is aimed at **Journal of Urban Economics (JUE)** and robustness strategy is the active bottleneck.
...
5. End with a handoff to `jue-tables-figures` if the stage passes, or back to `jue-workflow` if it does not.
