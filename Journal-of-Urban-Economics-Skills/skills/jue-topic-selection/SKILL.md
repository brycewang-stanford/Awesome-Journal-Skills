...
description: Use when working on topic selection for a Journal of Urban Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jue-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of Urban Economics (JUE)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jue-literature-positioning` if the stage passes, or back to `jue-workflow` if it does not.
