...
description: Use when working on literature positioning for a Journal of Economic Behavior and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jebo-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Economic Behavior and Organization (JEBO)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jebo-identification` if the stage passes, or back to `jebo-workflow` if it does not.
