...
description: Use when working on submission preflight for a Journal of Economic Behavior and Organization manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Submission Preflight (jebo-submission)

## When to trigger
- The manuscript is aimed at **Journal of Economic Behavior and Organization (JEBO)** and submission preflight is the active bottleneck.
