<!-- Vendored from shared-resources/empirical-methods/code (Stata 18 MP verified, 2026-06) for Population and Development Review (PDR). Do not edit commands here; edit the canonical source. -->
