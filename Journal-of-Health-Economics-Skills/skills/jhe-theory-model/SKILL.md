...
description: Use when working on theory and model craft for a Journal of Health Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory and Model Craft (jhe-theory-model)

## When to trigger
- The manuscript is aimed at **Journal of Health Economics (JHE)** and theory and model craft is the active bottleneck.
...
5. End with a handoff to `jhe-robustness` if the stage passes, or back to `jhe-workflow` if it does not.
