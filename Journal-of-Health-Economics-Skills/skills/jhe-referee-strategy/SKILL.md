...
description: Use when working on referee strategy for a Journal of Health Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Referee Strategy (jhe-referee-strategy)

## When to trigger
- The manuscript is aimed at **Journal of Health Economics (JHE)** and referee strategy is the active bottleneck.
...
5. End with a handoff to `jhe-submission` if the stage passes, or back to `jhe-workflow` if it does not.
