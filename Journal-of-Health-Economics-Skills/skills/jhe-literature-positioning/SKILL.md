...
description: Use when working on literature positioning for a Journal of Health Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jhe-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Health Economics (JHE)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jhe-identification` if the stage passes, or back to `jhe-workflow` if it does not.
