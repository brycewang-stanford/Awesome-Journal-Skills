...
description: Use when working on topic selection for a Journal of Health Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jhe-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of Health Economics (JHE)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jhe-literature-positioning` if the stage passes, or back to `jhe-workflow` if it does not.
