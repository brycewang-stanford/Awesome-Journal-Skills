---
name: jhe-rebuttal
description: Use when working on rebuttal strategy for a Journal of Health Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Rebuttal Strategy (jhe-rebuttal)

## When to trigger
- The manuscript is aimed at **Journal of Health Economics (JHE)** and rebuttal strategy is the active bottleneck.
...
5. End with a handoff to `jhe-rebuttal` if the stage passes, or back to `jhe-workflow` if it does not.
