---
name: jhe-submission
description: Use when working on submission preflight for a Journal of Health Economics manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Submission Preflight (jhe-submission)

## When to trigger
- The manuscript is aimed at **Journal of Health Economics (JHE)** and submission preflight is the active bottleneck.
