...
Capability layer for the **Operations Research** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of an *Operations Research* introduction in operational-problem → model-and-method → analytical-result → managerial-insight style, kept equation-free. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Operations Research* (INFORMS) papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
