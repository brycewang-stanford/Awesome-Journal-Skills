# Journal of Banking and Finance — Resources

Capability layer for the **Journal of Banking and Finance** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a JBF introduction in finance-question → headline-estimate → identification → mechanism style. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Banking & Finance* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
