# Journal of Public Economics — Resources

Capability layer for the **Journal of Public Economics** skill pack. The runnable code is vendored for
...
| [`worked-examples/01-introduction.md`](worked-examples/01-introduction.md) | Before→after rewrite of a JPubE introduction in policy-question → causal-estimate → welfare-translation style. Fictional teaching paper. |
...
| [`exemplars/library.md`](exemplars/library.md) | Real, web-verified *Journal of Public Economics* papers by topic × method, with a sibling-journal omission guard. Design positioning only — read the originals before citing numbers. |
