...
| [`official-source-map.md`](official-source-map.md) | ***Mathematical Finance*-specific policy & facts:** Wiley Research Exchange LaTeX submission, self-contained-proofs / appendix conventions, numerics-must-support-theory rule, single-blind review, Wiley Data Availability Statement, Bachelier Finance Society affiliation, and the 待核实 (to-verify) editor/APC items. The authoritative pack source. |
