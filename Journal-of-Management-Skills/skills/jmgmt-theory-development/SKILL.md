...
description: Use when working on theory development for a Journal of Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Theory Development (jmgmt-theory-development)

## When to trigger
- The manuscript is aimed at **Journal of Management (JOMgmt)** and theory development is the active bottleneck.
...
5. End with a handoff to `jmgmt-literature-positioning` if the stage passes, or back to `jmgmt-workflow` if it does not.
...
【Skill】jmgmt-theory-development
...
【Next skill】jmgmt-literature-positioning
```
