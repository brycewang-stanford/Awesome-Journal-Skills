...
description: Use when working on tables and figures for a Journal of Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Tables and Figures (jmgmt-tables-figures)

## When to trigger
- The manuscript is aimed at **Journal of Management (JOMgmt)** and tables and figures is the active bottleneck.
...
5. End with a handoff to `jmgmt-writing-style` if the stage passes, or back to `jmgmt-workflow` if it does not.
...
【Next skill】jmgmt-writing-style
```
