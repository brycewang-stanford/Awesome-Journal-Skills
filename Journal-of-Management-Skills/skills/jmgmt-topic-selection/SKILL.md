...
description: Use when working on topic selection for a Journal of Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Topic Selection (jmgmt-topic-selection)

## When to trigger
- The manuscript is aimed at **Journal of Management (JOMgmt)** and topic selection is the active bottleneck.
...
5. End with a handoff to `jmgmt-theory-development` if the stage passes, or back to `jmgmt-workflow` if it does not.
