...
description: Use when working on literature positioning for a Journal of Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Literature Positioning (jmgmt-literature-positioning)

## When to trigger
- The manuscript is aimed at **Journal of Management (JOMgmt)** and literature positioning is the active bottleneck.
...
5. End with a handoff to `jmgmt-methods` if the stage passes, or back to `jmgmt-workflow` if it does not.
