...
description: Use when working on writing style for a Journal of Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Writing Style (jmgmt-writing-style)

## When to trigger
- The manuscript is aimed at **Journal of Management (JOMgmt)** and writing style is the active bottleneck.
...
5. End with a handoff to `jmgmt-submission` if the stage passes, or back to `jmgmt-workflow` if it does not.
