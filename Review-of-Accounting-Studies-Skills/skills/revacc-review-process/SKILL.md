...
description: Use when working on review process for a Review of Accounting Studies manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Review Process (revacc-review-process)

## When to trigger
- The manuscript is aimed at **Review of Accounting Studies (RAST)** and review process is the active bottleneck.
