---
name: revacc-methods
description: Use when working on methods for a Review of Accounting Studies manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Methods (revacc-methods)

## When to trigger
- The manuscript is aimed at **Review of Accounting Studies (RAST)** and methods is the active bottleneck.
...
5. End with a handoff to `revacc-data-analysis` if the stage passes, or back to `revacc-workflow` if it does not.
