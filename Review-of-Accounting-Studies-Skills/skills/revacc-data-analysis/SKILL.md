...
description: Use when working on data analysis for a Review of Accounting Studies manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Data Analysis (revacc-data-analysis)

## When to trigger
- The manuscript is aimed at **Review of Accounting Studies (RAST)** and data analysis is the active bottleneck.
...
5. End with a handoff to `revacc-contribution-framing` if the stage passes, or back to `revacc-workflow` if it does not.
