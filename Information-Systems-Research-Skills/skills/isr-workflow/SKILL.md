...
> Editorial team changes: Suprateek Sarker (University of Virginia, McIntire) is the current Editor-in-Chief (inaugural editorial ISR 34(1):1-4, Feb 27, 2023); the 2025 multimethod-research framework editorial (ISR 36(2)) formalizes guidance for combining qualitative, quantitative, and analytical methods. Verify the current masthead and policies at pubsonline.informs.org/journal/isre — exact term dates and the submission fee are 待核实.
