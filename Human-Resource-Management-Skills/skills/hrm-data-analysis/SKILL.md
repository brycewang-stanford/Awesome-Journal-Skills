...
description: Use when working on data analysis for a Human Resource Management manuscript. Provides journal-specific decision checks and handoff criteria; it does not invent evidence or citations.
---

# Data Analysis (hrm-data-analysis)

## When to trigger
- The manuscript is aimed at **Human Resource Management (HRM)** and data analysis is the active bottleneck.
...
5. End with a handoff to `hrm-contribution-framing` if the stage passes, or back to `hrm-workflow` if it does not.
